 ...
 */
import { newPost, getUrl, publishPost } from '../support/utils';
...
describe('Preview', () => {
	...
	async function openPreviewPage(editorPage) {
		...
		/* OVERRIDE */
		await editorPage.waitForSelector('.editor-post-preview');
		/* END OVERRIDE */
	...
	async function waitForPreviewNavigation(previewPage) {
		...
		/* OVERRIDE */
		await page.waitForSelector('.editor-post-preview');
		/* END OVERRIDE */
